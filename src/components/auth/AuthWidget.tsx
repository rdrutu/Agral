...
export function AuthWidget() {
  ...
  return (
    <Card className="w-full shadow-2xl border-border/50 overflow-hidden bg-background/95 backdrop-blur-xl flex flex-col min-h-[600px] h-auto">
      <CardContent className="p-4 md:p-6 flex-1 flex flex-col">
        <Tabs value={activeTab} onValueChange={(v) => { setActiveTab(v as any); setError(null); }} className="w-full flex-1 flex flex-col">
          <TabsList className="grid w-full grid-cols-2 mb-4 h-11 bg-muted/60 p-1 shrink-0">
          ...
          <div className="flex-1 relative">
            ...
            <div className="absolute inset-0 overflow-y-auto overflow-x-hidden p-1 flex flex-col justify-center">
              <TabsContent value="login" className="space-y-6 mt-0 animate-in slide-in-from-left-2 duration-300">
            ...
            <TabsContent value="register" className="space-y-6 mt-0 animate-in slide-in-from-right-2 duration-300">
              <div className="text-center mb-6">
              ...
              <form onSubmit={handleRegister} className="space-y-4">
                ...
                <div className="flex items-start space-x-2 py-2">
                  ...
                  <div className="grid gap-1.5 leading-none">
                    ...
                    >
                      Sunt de acord cu{" "}
                      <Link href="/termeni-si-conditii" target="_blank" className="text-primary hover:underline font-bold">
                        Termenii și Condițiile
                      </Link>{" "}
                      și{" "}
                      <Link href="/confidentialitate" target="_blank" className="text-primary hover:underline font-bold">
                ...
                <Button
                  type="submit"
                  className="w-full h-12 mt-2 agral-gradient text-white font-bold text-base shadow-lg hover:opacity-90 transition-opacity disabled:opacity-50 disabled:grayscale disabled:cursor-not-allowed"
